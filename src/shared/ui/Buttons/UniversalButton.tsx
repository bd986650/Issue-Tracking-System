...
export default function UniversalButton({
  ...
  const variantClasses = {
    primary: "bg-blue-500 text-white hover:opacity-95 focus:ring-blue-500 disabled:opacity-50",
    secondary: "bg-gray-600 text-white hover:bg-gray-700 focus:ring-gray-500 disabled:opacity-50",
    outline: "border border-gray-300 text-gray-700 hover:opacity-90 focus:ring-blue-500 disabled:opacity-50"
  };
